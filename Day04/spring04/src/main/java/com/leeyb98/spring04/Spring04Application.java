...
public class Spring04Application {
	...
	public static void main(String[] args) {
		...
		// Stream API
		// 1. 기존방식
		System.out.println("기존방식식");
		List<String> avengers = Arrays.asList("IronMan", "Captain America", "SpiderMan", "Hulk");
		...
		// 2. 스트림API 사용방식
		avengers = Arrays.asList("IronMan", "Captain American", "SpiderMan", "Hulk", "AntMan");
